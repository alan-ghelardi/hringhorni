...
func Get(ctx context.Context, selector string) v1alpha1.AnalysisTemplateInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/nubank/hringhorni/pkg/argoclient/informers/externalversions/rollouts/v1alpha1.AnalysisTemplateInformer with selector %s from context.", selector)
	}
