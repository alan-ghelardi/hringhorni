...
import (
	...
	internalinterfaces "github.com/nubank/hringhorni/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/nubank/hringhorni/pkg/client/listers/rollouts/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.HringhorniV1alpha1().Analysises(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HringhorniV1alpha1().Analysises(namespace).Watch(context.TODO(), options)
			},
		},
		&rolloutsv1alpha1.Analysis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *analysisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rolloutsv1alpha1.Analysis{}, f.defaultInformer)
}
