...
import (
	...
	rollout "github.com/nubank/hringhorni/pkg/client/injection/informers/rollouts/v1alpha1/rollout"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "rollout-controller"
	defaultFinalizerName       = "rollouts.hringhorni.nu.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rolloutInformer := rollout.Get(ctx)
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "hringhorni.nu.dev.Rollout"),
	)
