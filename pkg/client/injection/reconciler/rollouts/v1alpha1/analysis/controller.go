...
import (
	...
	versionedscheme "github.com/nubank/hringhorni/pkg/client/clientset/versioned/scheme"
	client "github.com/nubank/hringhorni/pkg/client/injection/client"
	analysis "github.com/nubank/hringhorni/pkg/client/injection/informers/rollouts/v1alpha1/analysis"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "analysis-controller"
	defaultFinalizerName       = "analysises.hringhorni.nu.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	analysisInformer := analysis.Get(ctx)

	lister := analysisInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "hringhorni.nu.dev.Analysis"),
	)
