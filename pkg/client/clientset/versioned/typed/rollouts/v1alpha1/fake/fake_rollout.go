...
var rolloutsResource = schema.GroupVersionResource{Group: "hringhorni.nu.dev", Version: "v1alpha1", Resource: "rollouts"}

var rolloutsKind = schema.GroupVersionKind{Group: "hringhorni.nu.dev", Version: "v1alpha1", Kind: "Rollout"}
